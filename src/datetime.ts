...
export function dateStrToDateStr(datestr: string, sourceFormat: string, targetFormat: string): string {
  return toStringFormat(moment.utc(datestr, sourceFormat), targetFormat)
}